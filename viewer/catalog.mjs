...
export const PAGES = [
  ...
  },
  {
    ...
    "blank": "선언한 줄이 전부 선다. 이름 옆마다 값이 올 자리를 비운다. 줄마다 값의 생김새(수 칸이냐 글줄이냐)를 따르고, 굴리는 것은 뷰어다 — 산출물은 자리만 낸다",
  ...
  },
  {
    ...
    "blank": "두 축만 선다. 값이 없으면 눈금도 없다 — 눈금을 지어내면 그것이 가짜 값이다. 축 위에 모양이 바뀌는 선 하나가 서고, 그것을 움직이는 것은 뷰어다 — 산출물은 자리만 낸다",
