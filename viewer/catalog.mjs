...
export const PAGES = [
  ...
  },
  {
    ...
    "blank": "수 하나가 크게 설 자리를 그 크기 그대로 비운다. 필드 이름은 선다. 수가 설 칸과 단위가 서고, 그 칸을 굴리는 것은 뷰어다 — 산출물은 자리만 낸다",
  ...
  },
  {
    ...
    "blank": "선언한 줄이 전부 선다. 이름 옆마다 값이 올 자리를 비운다. 줄마다 값의 생김새(수 칸이냐 글줄이냐)를 따르고, 굴리거나 써 넣는 것은 뷰어다 — 산출물은 자리만 낸다",
  ...
  },
  {
    ...
    "blank": "필드마다 빈 자가 선다. 길이 0 의 막대가 아니라 채우지 않은 자다. 자마다 모양이 바뀌는 표식이 서고, 그것을 움직이는 것은 뷰어다 — 산출물은 자리만 낸다",
  ...
  },
  {
    ...
    "blank": "두 축만 선다. 값이 없으면 눈금도 없다 — 눈금을 지어내면 그것이 가짜 값이다. 꺾은선을 여럿 미리 그려 두고, 그중 하나씩 갈아 끼우는 것은 뷰어다 — 산출물은 자리만 낸다",
  ...
  },
  {
    ...
    "blank": "키 열이 서고 그 옆 한 칸이 subject 가 올 자리로 비어 있는다. 열은 subject 가 만든다. 열 머리와 칸이 값의 생김새를 따르고, 굴리는 것은 뷰어다 — 산출물은 자리만 낸다",
  ...
  },
  {
    ...
    "blank": "열 머리가 전부 선다. 열은 템플릿이 선언한 것이라 subject 없이도 안다. 칸마다 그 열의 생김새를 따르고, 굴리는 것은 뷰어다 — 산출물은 자리만 낸다",
  ...
  },
  {
    ...
    "blank": "빈 띠가 선다. 조각 이름은 값이 갖고 오는 것이라 지어내지 않는다. 띠 위에 마디가 바뀌는 표식이 서고, 그것을 움직이는 것은 뷰어다 — 산출물은 자리만 낸다",
