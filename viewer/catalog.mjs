...
export const PAGES = [
  ...
  },
  {
    ...
    "note": "축이 둘이라 선끼리 갈린다. 누가 누구인지는 선 끝의 이름이 말해 아래에 범례를 두지 않고, 무엇을 보는 중인지는 지금·직전·나머지 세 갈래의 색과 굵기가 말한다. 가로축은 age·date·duration·number 만 된다",
    "fields": "1",
    "shapes": [
      "series"
    ],
  ...
  },
  {
    ...
    "note": "누가 그 항목을 갖고 누가 안 갖는지가 한 줄에서 읽힌다. 목록을 못 읽은 것(—)과 읽었는데 그 항목이 없는 것(·)은 표기가 다르다",
    "fields": "1",
    "shapes": [
      "items"
    ],
