...
export type WeaveType = "number" | "money" | "ratio" | "duration" | "age" | "boolean" | "text" | "date";
export const WEAVE_TYPES = ["number", "money", "ratio", "duration", "age", "boolean", "text", "date"] as const satisfies readonly WeaveType[];

/** 크기를 견줄 수 있는 타입. */
export type WeaveNumericType = "number" | "money" | "ratio" | "duration" | "age";
export const WEAVE_NUMERIC_TYPES = ["number", "money", "ratio", "duration", "age"] as const satisfies readonly WeaveNumericType[];

/** 순서를 매길 수 있는 타입. range 와 series 축이 쓴다. */
export type WeaveOrderedType = "number" | "money" | "ratio" | "duration" | "age" | "date";
export const WEAVE_ORDERED_TYPES = ["number", "money", "ratio", "duration", "age", "date"] as const satisfies readonly WeaveOrderedType[];
