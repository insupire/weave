...
# 크기를 견줄 수 있는 타입.
NumericType = Literal["number", "money", "ratio", "multiple", "duration", "age"]
NUMERICTYPES: tuple[NumericType, ...] = ("number", "money", "ratio", "multiple", "duration", "age",)

# 순서를 매길 수 있는 타입. range 와 series 축이 쓴다.
OrderedType = Literal["number", "money", "ratio", "multiple", "duration", "age", "date"]
ORDEREDTYPES: tuple[OrderedType, ...] = ("number", "money", "ratio", "multiple", "duration", "age", "date",)
